...
- **en-US** (`Source/en-US`): Module help file location. Generated by the build task `updateExternalHelp` using the module `Microsoft.PowerShell.PlatyPS` to generate XML based help from markdown help files in the Docs folder.
