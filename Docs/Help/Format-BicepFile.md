...
Format-BicepFile [[-Path] <String>] [[-NewlineOption] <String>] [[-IndentKindOption] <String>]
 [[-IndentSize] <Int32>] [-InsertFinalNewline] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Format-BicepFile [[-Path] <String>] [[-NewlineOption] <String>] [[-IndentKindOption] <String>]
 [[-IndentSize] <Int32>] [-InsertFinalNewline] [-AsString] [-ProgressAction <ActionPreference>] [-WhatIf]
