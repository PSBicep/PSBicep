...
This is the repo for the Bicep PowerShell Module. The module is created as a wrapper for the [Bicep CLI](https://github.com/Azure/bicep). It started with a simple function to enable compilation on all bicep files in a folder, but I came up with additional use cases and the Bicep Module was born.
