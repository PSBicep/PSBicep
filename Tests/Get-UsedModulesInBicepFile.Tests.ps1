...
It '<name> should find modules used in the bicep file' {
    ...
    $result = Get-UsedModulesInBicepFile -Path $_.fullName
...
Describe 'New-BicepMarkdownDocumentation' {
    It 'should throw an error if the file does not exist' {
        $result = Get-UsedModulesInBicepFile -Path 'doesnotexist.bicep' -ErrorAction SilentlyContinue
