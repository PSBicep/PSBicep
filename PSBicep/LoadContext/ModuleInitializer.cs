...
public class BicepModuleInitializer : IModuleAssemblyInitializer
{
    ...
    private static readonly string s_binCommonPath = Path.Combine(s_binBasePath, "PSBicep.Core");
        ...
        AssemblyName assemblyName)
    {
        ...
        if (!assemblyName.Name.Equals("PSBicep.Core"))
        {
            return null;
        }
